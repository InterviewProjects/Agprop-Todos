...
class ApiController {
  ...
  LocalStorage get _localStorage => GetIt.I<LocalStorage>();

  Future<Map<String, String>> get _httpHeaders async => {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer ${_localStorage.getString(ACCESS_TOKEN)}',
  ...
  T? _parseResponse<T>(dynamic resBody) {
    ...
    try {
      ...
      switch(T) {
        ...
        case TitleListResponse:
          returnValue = TitleListResponse.fromJson(decodedBody) as T;
          break;
      }
    } catch(e) {
      /// do nothing
